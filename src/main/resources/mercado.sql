...
insert into CAFES values('Colombian', 00101, 7.99, 12, 4);
insert into CAFES values('French_Roast', 00049, 8.99, 20, 1);
insert into CAFES values('Espresso', 00150, 9.99, 2, 32);
insert into CAFES values('Colombian_Decaf', 00101, 8.99,43, 45);
insert into CAFES values('French_Roast_Decaf', 00049, 9.99, 54, 0);